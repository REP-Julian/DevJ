                        ...
                        <div className="flex items-center gap-2">
                            {formData.imageUrl && (
                                ...
                                >
                                    ...
                                    <span>{aiVisionScanning ? 'Reading Visual...' : 'AI Read Visual'}</span>
                                </button>
                            )}
                            <button
                                type="button"
                                ...
                                {visualReport.visualHighlights?.length > 0 && (
                                    <div className="flex flex-wrap gap-1.5 pt-1">
                                        {visualReport.visualHighlights.map((hl, i) => (
                                            <span key={i} className="px-2 py-0.5 bg-emerald-100/60 text-emerald-900 rounded-lg text-[10px] font-bold flex items-center gap-1">
                                                <Check className="w-3 h-3 text-emerald-600" /> {hl}
                                            </span>
                                        ))}
                                    </div>
                                )}
