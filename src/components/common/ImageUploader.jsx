    ...
    return (
        <div className="space-y-2">
            ...
            <div
                ...
                className={`relative border-2 border-dashed rounded-xl p-4 transition-all cursor-pointer flex flex-col items-center justify-center min-h-[160px] bg-white group ${dragActive
